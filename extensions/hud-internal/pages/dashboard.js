  ...
  var SECTIONS = [
    {
      cat: 'zwire', label: '// ZWIRE · HUD PAGES', tiles: [
        ...
        zt('files.html',        'Files',         'Multi-pane file browser — tree, preview, context menu (shared zpwr-file-browser).', '📁'),
        zt('history.html',      'History',       'Browsing history with fzf fuzzy search.', '◷'),
        zt('timeline.html',     'Timeline',      'Browsing history on the clip-engine arrangement grid — one lane per site, hourly columns.', '▥'),
